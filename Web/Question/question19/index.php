<?php
// 올바른 플래그 값
$correct_flag = "FLAG{this_is_easy}";
...
<head>
    ...
    <title>Challenge 19: Find Flag</title>
    <style>
        body {
...
<body>
    <h1>Find Flag</h1>
    <div class="container">
        <p>SSH 접속 후 숨겨진 파일을 찾고, 올바른 플래그를 제출하세요.</p>
    ...
    <div class="ssh-info">
        ...
        <p>사용자: <span style="color: #00ff00;">flame19</span></p>
    ...
    <script>
        async function submitFlag() {
            ...
            try {
                const response = await fetch('question19.php', {
                    method: 'POST',
